...
*/
let quotes = ["Make today a  great day or not, the choice is yours", "Never Give Up", "Just Do It" ];
...
console.log("Thomas' outfit is ", thomShirt + " ," + thomPants + " , "+ thomAcc); 
...
console.log(getMultipleLengths(["pringles", "doritos", "flamin hot", "fritos"]));
